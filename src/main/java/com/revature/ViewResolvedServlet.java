...
public class ViewResolvedServlet extends HttpServlet {
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ...
        out.println("<h1 class=\"center\">Resolved Reimbursement Requests Page</h1>");
        out.println("<br><br>");
        ...
        List<Reimbursement> reimbursements = reimbursementDao.getResolvedReimbursements(userId);
